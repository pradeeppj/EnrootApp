...
import com.example.letsstart.common.LowPassFilter;
import com.example.letsstart.common.Matrix;
import com.example.letsstart.common.MyData;
import com.example.letsstart.common.Navigation;
import com.example.letsstart.common.Orientation;
 ...
 * 
 * And will set Data in MyData < which are globle data ....ready to use ..>>
 * 
...
public class SensorsActivity extends Activity implements SensorEventListener,
	...
	/*
	 * Using Matrix operations instead. This was way too inaccurate, private_logo
	...
	public void onSensorChanged(SensorEvent evt) {
		...
		if (evt.sensor.getType() == Sensor.TYPE_ACCELEROMETER) {
			...
			MyData.setDeviceOrientation(Orientation.getDeviceOrientation());
			MyData.setDeviceOrientationAngle(Orientation.getDeviceAngle());
		 ...
		 * (floatAzimuth<0) floatAzimuth+=360; MyData.setAzimuth(floatAzimuth);
		 * MyData.setPitch((float)Math.toDegrees(apr[1]));
		 * MyData.setRoll((float)Math.toDegrees(apr[2]));
		 */
